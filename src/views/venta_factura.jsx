...
import TablaVentas from '../components/venta_factura/TablaVentas';
import { Container, Button, Row, Col} from "react-bootstrap";
import ModalDetallesVenta from '../components/detalles_ventas/ModalDetallesVenta';
import ModalEliminacionVenta from '../components/venta_factura/ModalEliminacionVenta';
import ModalRegistroVenta from '../components/venta_factura/ModalRegistroVenta';
import ModalActualizacionVenta from '../components/venta_factura/ModalActualizacionVenta';
...
const Ventas = () => {
  ...
  const [ setMostrarModalRegistro] = useState(false);
